...
void main() {
  test('OpenAI model discovery uses the preset URL and filters non-chat models', () async {
  ...
  test('Gemini model discovery uses x-goog-api-key and generateContent models', () async {
    final client = MockClient((request) async {
      expect(
